...
HELP_MESSAGE = '''**Hello, {}
I Am Dsshortener, Bulk Link Converter Bot. I Can Convert Links Directly From Your Dsshortener Account,**
...
ABOUT_TEXT = '''**Hey! My name is @DSShortenerConverterBot. I am DS Shortener Link Converter Bot.**

**⚡Features⚡**

• I can **Convert any** links or posts to your **Dsshortener** link / post. (Button Links Posts, Hidden links/Hyperlinks All Are Supported)
...
Ex: https://t.me/ds_backup | Dsshortener"""
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'http://Dsshortener.xyz/member/tools/api')
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](http://Dsshortener.xyz/member/tools/api)
...
Get API From [{base_site}](http://Dsshortener.xyz/member/tools/api)
...
USERNAME_TEXT = """**Hello , I am Dsshortener, Bulk Link Converter Bot From Linked Dsshortener.xyz Account,**
...
/channel @ds_backup
Or
/channel https://t.me/ds_backup

**🤘 Hit** 👉 /features To Know More Features Of This Bot.

**- Message @unknow_ds For More Help -**"""
